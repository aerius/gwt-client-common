 ...
 * will suffice.
 *
 * You can use {@link Projection#get(String)} to retrieve the object for a particular
 * projection.
 *
...
public class Projection {
     ...
     @JsFunction
     public interface PointResolutionFunc {
    ...
    public Projection(final ProjectionOptions projectionOptions) {}
     ...
     */
    public native void setGetPointResolution(PointResolutionFunc func);
    ...
    public static native boolean equivalent(Projection projection1, Projection projection2);
